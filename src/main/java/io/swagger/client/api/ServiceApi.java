...
public class ServiceApi {
     ...
     */
    public com.squareup.okhttp.Call serviceCreateCall(Body body, String xRegistryAuth, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call serviceCreateValidateBeforeCall(Body body, String xRegistryAuth, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public ServiceCreateResponse serviceCreate(Body body, String xRegistryAuth) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ServiceCreateResponse> serviceCreateWithHttpInfo(Body body, String xRegistryAuth) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call serviceCreateAsync(Body body, String xRegistryAuth, final ApiCallback<ServiceCreateResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public String serviceLogs(String id, Boolean details, Boolean follow, Boolean stdout, Boolean stderr, Integer since, Boolean timestamps, String tail) throws ApiException {
        ApiResponse<String> resp = serviceLogsWithHttpInfo(id, details, follow, stdout, stderr, since, timestamps, tail);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> serviceLogsWithHttpInfo(String id, Boolean details, Boolean follow, Boolean stdout, Boolean stderr, Integer since, Boolean timestamps, String tail) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call serviceLogsAsync(String id, Boolean details, Boolean follow, Boolean stdout, Boolean stderr, Integer since, Boolean timestamps, String tail, final ApiCallback<String> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call serviceUpdateCall(String id, Body body, Integer version, String registryAuthFrom, String rollback, String xRegistryAuth, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call serviceUpdateValidateBeforeCall(String id, Body body, Integer version, String registryAuthFrom, String rollback, String xRegistryAuth, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ServiceUpdateResponse serviceUpdate(String id, Body body, Integer version, String registryAuthFrom, String rollback, String xRegistryAuth) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ServiceUpdateResponse> serviceUpdateWithHttpInfo(String id, Body body, Integer version, String registryAuthFrom, String rollback, String xRegistryAuth) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call serviceUpdateAsync(String id, Body body, Integer version, String registryAuthFrom, String rollback, String xRegistryAuth, final ApiCallback<ServiceUpdateResponse> callback) throws ApiException {
