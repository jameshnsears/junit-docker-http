...
public class PluginApi {
     ...
     */
    public List<Object> getPluginPrivileges(String remote) throws ApiException {
        ApiResponse<List<Object>> resp = getPluginPrivilegesWithHttpInfo(remote);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Object>> getPluginPrivilegesWithHttpInfo(String remote) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getPluginPrivilegesAsync(String remote, final ApiCallback<List<Object>> callback) throws ApiException {
