...
public class ImageApi {
     ...
     * @param filters A JSON encoded value of the filters (a &#x60;map[string][]string&#x60;) to process on the list of build cache objects. Available filters: - &#x60;unused-for&#x3D;&lt;duration&gt;&#x60;: duration relative to daemon&#39;s time, during which build cache was not used, in Go&#39;s duration format (e.g., &#39;24h&#39;) - &#x60;id&#x3D;&lt;id&gt;&#x60; - &#x60;parent&#x3D;&lt;id&gt;&#x60; - &#x60;type&#x3D;&lt;string&gt;&#x60; - &#x60;description&#x3D;&lt;string&gt;&#x60; - &#x60;inuse&#x60; - &#x60;shared&#x60; - &#x60;private&#x60;  (optional)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void imageBuild(byte[] inputStream, String dockerfile, String t, String extrahosts, String remote, Boolean q, Boolean nocache, String cachefrom, String pull, Boolean rm, Boolean forcerm, Integer memory, Integer memswap, Integer cpushares, String cpusetcpus, Integer cpuperiod, Integer cpuquota, String buildargs, Integer shmsize, Boolean squash, String labels, String networkmode, String contentType, String xRegistryConfig, String platform, String target) throws ApiException {
        imageBuildWithHttpInfo(inputStream, dockerfile, t, extrahosts, remote, q, nocache, cachefrom, pull, rm, forcerm, memory, memswap, cpushares, cpusetcpus, cpuperiod, cpuquota, buildargs, shmsize, squash, labels, networkmode, contentType, xRegistryConfig, platform, target);
    }
    ...
    public ApiResponse<Void> imageBuildWithHttpInfo(byte[] inputStream, String dockerfile, String t, String extrahosts, String remote, Boolean q, Boolean nocache, String cachefrom, String pull, Boolean rm, Boolean forcerm, Integer memory, Integer memswap, Integer cpushares, String cpusetcpus, Integer cpuperiod, Integer cpuquota, String buildargs, Integer shmsize, Boolean squash, String labels, String networkmode, String contentType, String xRegistryConfig, String platform, String target) throws ApiException {
        com.squareup.okhttp.Call call = imageBuildValidateBeforeCall(inputStream, dockerfile, t, extrahosts, remote, q, nocache, cachefrom, pull, rm, forcerm, memory, memswap, cpushares, cpusetcpus, cpuperiod, cpuquota, buildargs, shmsize, squash, labels, networkmode, contentType, xRegistryConfig, platform, target, null, null);
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call imageCreateCall(String fromImage, String fromSrc, String repo, String tag, String inputImage, String xRegistryAuth, String platform, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call imageCreateValidateBeforeCall(String fromImage, String fromSrc, String repo, String tag, String inputImage, String xRegistryAuth, String platform, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = imageCreateCall(fromImage, fromSrc, repo, tag, inputImage, xRegistryAuth, platform, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void imageCreate(String fromImage, String fromSrc, String repo, String tag, String inputImage, String xRegistryAuth, String platform) throws ApiException {
        imageCreateWithHttpInfo(fromImage, fromSrc, repo, tag, inputImage, xRegistryAuth, platform);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> imageCreateWithHttpInfo(String fromImage, String fromSrc, String repo, String tag, String inputImage, String xRegistryAuth, String platform) throws ApiException {
        com.squareup.okhttp.Call call = imageCreateValidateBeforeCall(fromImage, fromSrc, repo, tag, inputImage, xRegistryAuth, platform, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call imageCreateAsync(String fromImage, String fromSrc, String repo, String tag, String inputImage, String xRegistryAuth, String platform, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = imageCreateValidateBeforeCall(fromImage, fromSrc, repo, tag, inputImage, xRegistryAuth, platform, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
    ...
    public com.squareup.okhttp.Call imageGetAllCall(List<String> names, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (names != null)
        localVarCollectionQueryParams.addAll(apiClient.parameterToPairs("multi", "names", names));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Object> imageHistory(String name) throws ApiException {
        ApiResponse<List<Object>> resp = imageHistoryWithHttpInfo(name);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Object>> imageHistoryWithHttpInfo(String name) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call imageHistoryAsync(String name, final ApiCallback<List<Object>> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Object> imageSearch(String term, Integer limit, String filters) throws ApiException {
        ApiResponse<List<Object>> resp = imageSearchWithHttpInfo(term, limit, filters);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Object>> imageSearchWithHttpInfo(String term, Integer limit, String filters) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call imageSearchAsync(String term, Integer limit, String filters, final ApiCallback<List<Object>> callback) throws ApiException {
