...
public class SwarmApiTest {
    ...
    private final SwarmApi api = new SwarmApi();
     ...
     */
    @Test
    public void swarmInitTest() throws ApiException {
        Body1 body = null;
     ...
     */
    @Test
    public void swarmInspectTest() throws ApiException {
     ...
     */
    @Test
    public void swarmJoinTest() throws ApiException {
        Body2 body = null;
        api.swarmJoin(body);
     ...
     */
    @Test
    public void swarmLeaveTest() throws ApiException {
        Boolean force = null;
        api.swarmLeave(force);
     ...
     */
    @Test
    public void swarmUnlockTest() throws ApiException {
        Body3 body = null;
        api.swarmUnlock(body);
     ...
     */
    @Test
    public void swarmUnlockkeyTest() throws ApiException {
     ...
     */
    @Test
    public void swarmUpdateTest() throws ApiException {
        SwarmSpec body = null;
        Long version = null;
        Boolean rotateWorkerToken = null;
        Boolean rotateManagerToken = null;
        Boolean rotateManagerUnlockKey = null;
        api.swarmUpdate(body, version, rotateWorkerToken, rotateManagerToken, rotateManagerUnlockKey);
