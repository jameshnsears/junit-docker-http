...
public class ImageApiTest {
    ...
    public void imageBuildTest() throws ApiException {
        ...
        String target = null;
        api.imageBuild(inputStream, dockerfile, t, extrahosts, remote, q, nocache, cachefrom, pull, rm, forcerm, memory, memswap, cpushares, cpusetcpus, cpuperiod, cpuquota, buildargs, shmsize, squash, labels, networkmode, contentType, xRegistryConfig, platform, target);
    ...
    public void imageCreateTest() throws ApiException {
        ...
        String platform = null;
        api.imageCreate(fromImage, fromSrc, repo, tag, inputImage, xRegistryAuth, platform);
    ...
    public void imageHistoryTest() throws ApiException {
        String name = null;
        List<Object> response = api.imageHistory(name);
    ...
    public void imageSearchTest() throws ApiException {
        ...
        Integer limit = null;
        String filters = null;
        List<Object> response = api.imageSearch(term, limit, filters);
